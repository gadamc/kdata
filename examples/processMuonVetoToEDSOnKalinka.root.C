...
{
	//gSystem->Load("$HOME/dev/EdwDataStructure/lib/libEdwDS.so");  //load the EdwDataStructure library
	gSystem->Load("/kalinka/home/schmidt-b/develSvn/lib/libEdwDS.so");
	gSystem->AddIncludePath("-I/kalinka/home/schmidt-b/develSvn/src");
	gROOT->ProcessLine(".L fillMuonVetoEvents.cc+"); //compile your code, which uses the EdwDataStructure class library
