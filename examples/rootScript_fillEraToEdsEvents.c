...

{
	...
	TString libPath = devPath + "/lib/libEdwDS.so";
	...
	gSystem->Load(libPath.Data());  //load the EdwDataStructure library
	//gSystem->AddIncludePath("-I/kalinka/home/gadamc/dev/EdwDataStructure");
	//gSystem->Load("/kalinka/home/gadamc/dev/EdwDataStructure/lib/libEdwDS.so");  //load the EdwDataStructure library
	//gSystem->AddIncludePath("-I/kalinka/home/gadamc/dev/EdwDataStructure/src");//changed to absolute path, thus I can execute it from kalinka account
	//gROOT->ProcessLine(".L mergeEdsTree.cc+"); //compile your code, which uses the EdwDataStructure class library
