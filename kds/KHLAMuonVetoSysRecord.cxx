...
// Veto System record values are stored in the base class KMuonVetoSystemRecord.
//
...
ClassImp(KHLAMuonVetoSysRecord);

KHLAMuonVetoSysRecord::KHLAMuonVetoSysRecord(void)
{
...
void KHLAMuonVetoSysRecord::Clear(Option_t *opt)
{
