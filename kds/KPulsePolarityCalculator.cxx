...
int KPulsePolarityCalculator::GetExpectedPolarity(KAmpBoloPulseRecord *p, KAmpBolometerRecord* bolo)
{
...
int KPulsePolarityCalculator::GetExpectedPolarityFromFID(KAmpBolometerRecord* bolo, KAmpBoloPulseRecord *p)
{
  //
...
int KPulsePolarityCalculator::GetExpectedPolarityFromID(KAmpBolometerRecord* bolo, KAmpBoloPulseRecord *p)
{
  //
...
int KPulsePolarityCalculator::GetPolarityStandardCalculator(KAmpBolometerRecord *bolo, KAmpBoloPulseRecord *p)
{
