...
Int_t timebin=3600.*12; // ?? heures standard (12 ou 24?)
Float_t Ecution=50;
...
//BaselineEvol(chain,chal,echalntpfile,periodfile,baselinefile,bolonum,1);
...
Qplot(bolo,qualdir,DSTRed,voltflag,evtclassflag,cut_badevts,0,print_wimps,0);
...
string outfile=basedir+"qplot_"+bolo+".txt"; // "" pr rien sauver
Qplot(chain,bolo,qualdir,Eion,Echal,Cuts,volt,kappa,sigmacut_heat,sigmacut_ion,sigmacut_gamma,sigmacut_quasifid,doqualcut,dovetocut,dohist,print_wimps,dohist,-1,outfile);

//******
// Added Feb 2010... quick and dirty "DeltaEfid" plots

TChain* chain = new TChain("energytree","ID201 - Beta Calib");
//chain->AddFile("/Users/armengau/Data/Edelweiss/ID_Run10/olds/Ntps/Bckgd8V/eion_ID201.root");
chain->AddFile("/Users/armengau/Data/Edelweiss/ID_Run10/olds/Ntps/Bckgd4V/eion_ID201.root");
chain->AddFriend("cuttree","/Users/armengau/Data/Edelweiss/ID_Run10/olds/Ntps/Bckgd4V/cuts_ID201.root");

TCut lims="Efid>0 && Efid<50 && Ecol2-Ecol1<60 && Ecol2-Ecol1>-60";
TCut qual="cuttree.CutBases && cuttree.CutChi2Col1 && cuttree.CutChi2Col2 && cuttree.CutPeriod && cuttree.CutHeatIon";
TCut v1="Evet1<1.5 || Evet1 < 0.05*Ecol1";
TCut v2="Evet2<1.5 || Evet2 < 0.05*Ecol2";
TCut g1="Egar1<1.5 || Egar1 < 0.05*Efid";
TCut g2="Egar2<1.5 || Egar2 < 0.05*Efid";

chain->Draw("Ecol2-Ecol1:Efid",lims&&qual&&g1&&g2);
chain->SetMarkerColor(2);
chain->SetMarkerStyle(7);
chain->Draw("Ecol2-Ecol1:Efid",v1&&v2&&g1&&g2&&qual,"same");
