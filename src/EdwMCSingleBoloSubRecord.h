...
#ifndef __EDWMCSINGLEBOLOSUBRECORD_H__
#define __EDWMCSINGLEBOLOSUBRECORD_H__
...
class EdwMCSingleBoloSubRecord : public EdwHLASingleBoloSubRecord {

public:
  //Constructors
  EdwMCSingleBoloSubRecord(void);
	EdwMCSingleBoloSubRecord(const EdwMCSingleBoloSubRecord &aRec);
	EdwMCSingleBoloSubRecord& operator=(const EdwMCSingleBoloSubRecord &aRec);
  virtual ~EdwMCSingleBoloSubRecord(void);
	virtual void Clear(Option_t *opt = "C");
	Bool_t IsSame(const EdwMCSingleBoloSubRecord &aRec, Bool_t bPrint = false) const;
	Bool_t operator==(const EdwMCSingleBoloSubRecord &aRec) const { return IsSame(aRec,false); }
	Bool_t operator!=(const EdwMCSingleBoloSubRecord &aRec) const { return !(*this==aRec); }
...
private:
  ...
  void InitializeMembers(void);
	void CopyLocalMembers(const EdwMCSingleBoloSubRecord &aRec);
	
  ClassDef(EdwMCSingleBoloSubRecord,1);
};


#endif // __EDWMCSINGLEBOLOSUBRECORD_H__
